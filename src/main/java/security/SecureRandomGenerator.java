...
*
* <p> This class is a secure random generator for int and byte types
*
* @author  Rob
* @author  Sam
*/
...
/*
    byte uses int, because the byte interface, although lower, does not allow for bound creation.
*/
    ...
    */
    public static byte generateRandomByteWithBound(int bound) {
        if(bound >= 0 && bound <= _MAX_BYTE_VALUE_AS_INTEGER) {
            ...
            return (byte) generateRandomIntWithBound(_MAX_BYTE_VALUE_AS_INTEGER);
        }
    }
